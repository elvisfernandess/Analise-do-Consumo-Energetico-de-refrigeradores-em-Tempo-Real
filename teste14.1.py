...
import xlwings as xw  # Importando a biblioteca xlwings
import serial
import tkinter as tk
from tkinter import messagebox  # Importação corrigida
...
import threading  # Para gerenciar a execução em segundo plano

# Configuração da porta serial
porta_serial = 'COM3'  # Alterar para a porta correta
baud_rate = 9600
arquivo_saida = 'dados_arduino_indefinido.txt'

# Nome do arquivo JSON para salvar os dados
ARQUIVO_JSON = "refrigeradores.json"

# Variáveis ajustáveis
tarifa_energia = 0.80  # Exemplo de tarifa
potencia_nominal = 218.0  # Exemplo de potência nominal em watts
tensao_nominal = 220.0    # Exemplo de tensão nominal em volts
rendimento_nominal = 79.80  # Exemplo de rendimento nominal em %
consumo_mensal_nominal = 55.3  # Exemplo de consumo mensal nominal em kWh
limite_inferior_consumo = 52.0  # Exemplo de consumo inferior (em kWh)
limite_superior_consumo = 57.0  # Consumo de consumo superior (em kWh)
limite_inferior_temperatura_sensor_1 = 25.0  # Exemplo de temperatura inferior Sensor 1 (em ºC)
limite_superior_temperatura_sensor_1 = 27.0  # Exemplo de temperatura inferior Sensor 1 (em ºC)
limite_inferior_temperatura_sensor_2 = 25.0  # Exemplo de temperatura inferior Sensor 2 (em ºC)
limite_superior_temperatura_sensor_2 = 27.0  # Exemplo de temperatura inferior Sensor 2 (em ºC)
limite_inferior_rendimento = 70.0  # Exemplo de limite inferior (%)
limite_superior_rendimento = 90.0  # Exemplo de limite superior (%)
...
estado_atual_rendimento = None
horario_transicao_rendimento = None
