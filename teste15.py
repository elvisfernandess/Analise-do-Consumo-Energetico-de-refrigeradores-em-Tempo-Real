...
def atualizar_variaveis():
    ...
    global tarifa_energia, potencia_nominal, tensao_nominal
...
janela.title("Analisador de Consumo Energético de Refrigeradores") #titulo da janela
...
consumo_mensal_label.grid(row=9, column=0, padx=10, pady=5)
...
erro_absoluto_consumo_label.grid(row=10, column=0, padx=10, pady=5)
...
erro_relativo_consumo_label.grid(row=11, column=0, padx=10, pady=5)
...
custo_mensal_label.grid(row=12, column=0, padx=10, pady=5)
...
energia_label.grid(row=13, column=0, padx=10, pady=5)
...
custo_teste_label.grid(row=14, column=0, padx=10, pady=5)
...
tk.Label(janela, text="Consumo Mensal Nominal (kWh):").grid(row=4, column=9, padx=10, pady=5)
consumo_entry = tk.Entry(janela)
consumo_entry.insert(0, str(consumo_mensal_nominal))
consumo_entry.grid(row=4, column=10, padx=10, pady=5)
...
tk.Label(janela, text="Limite Inferior do Consumo Mensal Nominal(kWh):").grid(row=5, column=9, padx=10, pady=5)
limite_inferior_entry = tk.Entry(janela)
limite_inferior_entry.insert(0, str(limite_inferior_consumo))
limite_inferior_entry.grid(row=5, column=10, padx=10, pady=5)
...
tk.Label(janela, text="Limite Superior do Consumo Mensal Nominal (kWh):").grid(row=6, column=9, padx=10, pady=5)
limite_superior_entry = tk.Entry(janela)
limite_superior_entry.insert(0, str(limite_superior_consumo))
limite_superior_entry.grid(row=6, column=10, padx=10, pady=5)
...
tk.Label(janela, text="Limite Inferior Sensor Temperatura 1 (ºC):").grid(row=7, column=9, padx=10, pady=5)
...
limite_inferior_temperatura_sensor_1_entry.grid(row=7, column=10, padx=10, pady=5)
...
tk.Label(janela, text="Limite Superior Sensor Temperatura 1 (ºC):").grid(row=8, column=9, padx=10, pady=5)
...
limite_superior_temperatura_sensor_1_entry.grid(row=8, column=10, padx=10, pady=5)
...
tk.Label(janela, text="Limite Inferior Sensor Temperatura 2 (ºC):").grid(row=9, column=9, padx=10, pady=5)
...
limite_inferior_temperatura_sensor_2_entry.grid(row=9, column=10, padx=10, pady=5)
...
tk.Label(janela, text="Limite Superior Sensor Temperatura 2 (ºC):").grid(row=10, column=9, padx=10, pady=5)
...
limite_superior_temperatura_sensor_2_entry.grid(row=10, column=10, padx=10, pady=5)
...
#tk.Label(janela, text="Limite Inferior do Rendimento (%):").grid(row=11, column=9, padx=10, pady=5)
#limite_inferior_rendimento_entry = tk.Entry(janela)
#limite_inferior_rendimento_entry.insert(0, str(limite_inferior_rendimento))
#limite_inferior_rendimento_entry.grid(row=11, column=10, padx=10, pady=5)
